...
export const DataProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const value = useMemo(() => ({
        ...
        addCommendation, updateCommendation, deleteCommendation,
        deleteRadioChannel,
        updateDiscordConfig, updateHeroCardConfig, updateBrandingConfig, updateOpenGraphConfig, updateRadioConfig, updateAIConfig, updateWikiHomeConfig, reorderWikiPages, updatePublicPageConfig, listTestimonialCandidates,
        updateOrgFeatures,
        syncDiscordRoles, updateRankMapping,
        broadcastEAM,
